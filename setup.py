...
setup(
    name="azul-plugin-exiftool",
    description="Extract metadata from many filetypes using opensource ExifTool.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_exiftool"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-exiftool = azul_plugin_exiftool.main:main",
        ]
    },
